  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
        <div className="bg-white rounded-2xl border border-slate-200 shadow-lg p-10 max-w-md w-full text-center animate-in fade-in zoom-in duration-500">
      ...
      <main className="flex-1 flex items-start justify-center p-6 pt-10">
        <div className="w-full max-w-2xl">
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="bg-primary/5 border-b border-slate-100 px-6 py-4 flex items-center gap-2">
              <ClipboardCheck className="h-5 w-5 text-primary" />
              <span className="font-semibold text-slate-800">Class Record Form</span>
            </div>
              ...
              <Form {...form}>
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-slate-100">
                    ...
                    <Button
                      type="submit"
                      className="sm:flex-1 w-full order-1 sm:order-2 gap-2"
                      disabled={createStudent.isPending}
                    >
